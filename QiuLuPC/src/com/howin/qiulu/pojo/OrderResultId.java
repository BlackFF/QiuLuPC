...
public class OrderResultId implements java.io.Serializable {
	...
	public OrderResultId(int id, Long orderId, Integer userId, Timestamp createTime, float price, int number,
			Float total, Integer postage, Integer status, int skuId, String image, String sellPoint, String receiver,Float sprice,String deliveryPlace,Float paid) {
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (skuId != other.skuId)
			return false;
		if (Float.floatToIntBits(sprice) != Float.floatToIntBits(other.sprice))
			return false;
		if (status == null) {
